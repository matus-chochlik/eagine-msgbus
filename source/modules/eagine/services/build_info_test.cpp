...
// test 1
//------------------------------------------------------------------------------
void build_version_info_1(auto& s) {
    ...
    auto& provider = the_reg.emplace<eagine::msgbus::service_composition<
      eagine::msgbus::build_version_info_provider<>>>("Provider");
    auto& consumer = the_reg.emplace<eagine::msgbus::service_composition<
      eagine::msgbus::build_version_info_consumer<>>>("Consumer");
...
auto test_main(eagine::test_ctx& ctx) -> int {
    ...
    eagitest::ctx_suite test{ctx, "build version info", 1};
    test.once(build_version_info_1);
