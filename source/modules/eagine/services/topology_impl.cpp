...
//------------------------------------------------------------------------------
auto network_topology_impl::_handle_router(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
auto network_topology_impl::_handle_bridge(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
auto network_topology_impl::_handle_endpoint(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
auto network_topology_impl::_handle_router_bye(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
auto network_topology_impl::_handle_bridge_bye(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
auto network_topology_impl::_handle_endpoint_bye(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
void network_topology_impl::add_methods(subscriber& base) noexcept {
...
//------------------------------------------------------------------------------
auto network_topology_impl::decode_router_shutdown(
  const message_context& msg_ctx,
...
//------------------------------------------------------------------------------
auto network_topology_impl::decode_bridge_shutdown(
  const message_context& msg_ctx,
...
//------------------------------------------------------------------------------
auto network_topology_impl::decode_endpoint_shutdown(
  const message_context& msg_ctx,
