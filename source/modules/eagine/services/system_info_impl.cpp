...
//------------------------------------------------------------------------------
auto system_info_provider_impl::_handle_stats_query(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
auto system_info_provider_impl::_handle_sensor_query(
  const message_context& msg_ctx,
  const stored_message& message) noexcept -> bool {
...
//------------------------------------------------------------------------------
void system_info_provider_impl::add_methods(subscriber& base) noexcept {
...
void system_info_consumer_impl::add_methods(subscriber& base) noexcept {
    ...
    base.add_method(_temperature_min_max(signals.temperature_min_max_received)
...
//------------------------------------------------------------------------------
void system_info_consumer_impl::query_sensors(
  const endpoint_id_t endpoint_id) noexcept {
    message_view message{};
